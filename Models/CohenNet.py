...
class EP4CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = P4ConvP4(10, 10, kernel_size=3)
        self.conv3_bn = nn.BatchNorm3d(10)
        self.conv4 = P4ConvP4(10, 26, kernel_size=3)
        self.conv4_bn = nn.BatchNorm3d(26)
        self.conv5 = P4ConvP4(26, 26, kernel_size=3)
        self.conv5_bn = nn.BatchNorm3d(26)
        self.conv6 = P4ConvP4(26, 26, kernel_size=3)
        self.conv6_bn = nn.BatchNorm3d(26)
        self.conv7 = P4ConvP4(26, 26, kernel_size=4, padding=1)
...
class EearlyP4CNN(nn.Module):
    def __str__(self):
        return "EearlyP4CNN"

    def __init__(self):
        super(EearlyP4CNN, self).__init__()
        self.conv1 = P4ConvZ2(1, 10, kernel_size=3)
        self.conv1_bn = nn.BatchNorm3d(10)
        self.conv2 = P4ConvP4(10, 10, kernel_size=3)
        self.conv2_bn = nn.BatchNorm3d(10)
        ...
        self.conv4 = P4ConvP4(10, 26, kernel_size=3)
        self.conv4_bn = nn.BatchNorm3d(26)
        self.conv5 = nn.Conv2d(104, 52, kernel_size=3)
        self.conv5_bn = nn.BatchNorm2d(52)
        self.conv6 = nn.Conv2d(52, 52, kernel_size=3)
        self.conv6_bn = nn.BatchNorm2d(52)
        self.conv7 = nn.Conv2d(52, 26, kernel_size=4, padding=1)
...
class EZ2CNN(nn.Module):
    def __str__(self):
        return "EZ2CNN"

    def __init__(self):
        super(EZ2CNN, self).__init__()
        self.conv1 = nn.Conv2d(1, 20, kernel_size=3)
        self.conv1_bn = nn.BatchNorm2d(20)
        self.conv2 = nn.Conv2d(20, 20, kernel_size=3)
        self.conv2_bn = nn.BatchNorm2d(20)
        self.conv3 = nn.Conv2d(20, 20, kernel_size=3)
        self.conv3_bn = nn.BatchNorm2d(20)
        self.conv4 = nn.Conv2d(20, 46, kernel_size=3)
        self.conv4_bn = nn.BatchNorm2d(46)
        self.conv5 = nn.Conv2d(46, 46, kernel_size=3)
        self.conv5_bn = nn.BatchNorm2d(46)
        self.conv6 = nn.Conv2d(46, 92, kernel_size=3)
        self.conv6_bn = nn.BatchNorm2d(92)
        self.conv7 = nn.Conv2d(92, 26, kernel_size=4, padding=1)
        self.pool = nn.MaxPool2d(2,2)
