...
def testing():
    ...
    create_test_dir("experiments_EMNIST_stop_equivariance.py")
    train_loader, val_loader, test_loader = get_datasets(train_batch_size, val_batch_size, test_batch_size)
    models = [Models.EP4CNN, Models.EearlyP4CNN, Models.EZ2CNN]
    ...
    for model_to_test in models:
        ...
        with open("test_results/experiments_EMNIST_stop_equivariance.py/"+model_name+"-results.json", 'w') as outfile:
            outfile.write(json_object)

        torch.save(model.state_dict(), "test_results/experiments_EMNIST_stop_equivariance.py/"+model_name)
